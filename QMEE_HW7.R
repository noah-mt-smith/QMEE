...
# to losers, and b) that in terms of coaching hours, it depends on gender and the context of the competition. 
# In academics, it seems like people tend to want to help those struggling, while in athletics, it seems people 
# want to recruit and coach stronger players (at least for males, while for females it is unclear).
